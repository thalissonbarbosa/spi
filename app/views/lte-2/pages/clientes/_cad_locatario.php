<div class="box box-default">
    <div class="box-header with-border">
        <span class="box-title">Cadastrar Locatário</span>
    </div>

    <form id="insert_locatario" action="" method="post">
        <div class="box-body">
            ...
            <div class="nav-tabs-custom tab-purple">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="fiador"><a href="#fiador" data-toggle="tab">Fiador</a></li>
                </ul> <!-- nav -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="garantia" class="form-control">
                                        <option selected value="fiador" onClick="$('.fiador').show(); $('.valor_caucao').hide()">Fiador</option>
                                        <option value="caução" onClick="$('.fiador').hide(); $('.valor_caucao').show()">Caução</option>
                                    </select>
                                </div>
                                <div class="form-group valor_caucao" style="display:none;">
                                    <label>Valor da Caução</label>
                                    <input type="text" name="valor_caucao" class="form-control valor text-olive" />
                                </div>

                                <div class="form-group">
                                    <label class="obrigatorio">Nome</label>
                                    <input type="text" class="form-control" name="nome" name="nome" required />
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                    ...
                    <div id="profissional" class="tab-pane">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label>Salário</label>
                                    <input type="text" class="form-control valor text-olive" name="prof_salario" />
                                </div>
                            ...
                            <div class="col-md-4 bg-light-gray">
                                <div class="form-group">
                                    <label>CEP</label>
                                    <input class="form-control cep" type="text" id="prof_cep" name="prof_cep" />
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label>Rua</label>
                                            <input class="form-control"  type="text" id="prof_rua" name="prof_rua" />
                                        </div>
                                        <div class="col-md-4">
                                            <label>Nº</label>
                                            <input class="form-control"  type="text" id="prof_numero" name="prof_numero" />
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label>Bairro</label>
                                            <input class="form-control"  type="text" id="prof_bairro" name="prof_bairro" />
                                        </div>
                                        <div class="col-md-4">
                                            <label>Zona</label>
                                ...
                                <div class="form-group">
                                    <label>Cidade</label>
                                    <input class="form-control"  type="text" id="prof_cidade" name="prof_cidade" />
                                </div>
                            </div> <!-- right -->
                        </div>
                    </div> <!-- ./profissional -->
                    ...
                    <div id="conjuge" class="tab-pane">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label>Firma</label>
                                    <input type="text" class="form-control" name="conj_firma" />
                                </div>
                                <div class="form-group">
                                    <label>Salário</label>
                                    <input type="text" class="form-control valor text-olive" name="conj_salario" />
                                </div>
                            </div> <!-- left -->
                        </div>
                    </div> <!-- ./conjuge -->
        ...
        <div class="box-footer">
            ...
            <input type="button" class="btn btn-flat bg-red btn-lg col-sm-2" value="Cancelar" onClick="history.back()" />
        </div>
    </form>
