<div class="box box-default">
    <div class="box-header with-border">
        <span class="box-title">Cadastrar Fiador</span>
    </div>

    <form id="insert_fiador" action="" method="post">
        <div class="box-body">
            ...
            <div class="nav-tabs-custom tab-purple">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="locatario"><a href="#locatario" data-toggle="tab">Locatário</a></li>
                </ul> <!-- nav -->
