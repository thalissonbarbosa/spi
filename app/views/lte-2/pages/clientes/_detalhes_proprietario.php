...
$ProprietarioImovel = new Imovel\Proprietarios_DAO();
$Imovel = new Imovel\Imovel_DAO();

$result = $Proprietario->get($id);
$repres_display = (empty($result['representante'])) ? 'display: none;' : '';

$empresa = $Proprietario->getEmpresa($id);
...
$imovel = $ProprietarioImovel->getList("WHERE cl_proprietarios_id = '{$id}'");
?>
